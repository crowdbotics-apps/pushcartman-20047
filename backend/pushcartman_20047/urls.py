"""pushcartman_20047 URL Configuration
...
admin.site.site_header = "PushCartMan"
admin.site.site_title = "PushCartMan Admin Portal"
admin.site.index_title = "PushCartMan Admin"

# swagger
api_info = openapi.Info(
    title="PushCartMan API",
    default_version="v1",
    description="API documentation for PushCartMan App",
)
